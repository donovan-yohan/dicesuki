...
> Part of the [Harness documentation system](../../CLAUDE.md).
...
| [imagegen-uv-dice.md](imagegen-uv-dice.md) | ImageGen UV atlas templates, prompts, and Blender/Three.js workflow |
