...
| Star bundle remainders | Most Star bundles are not multiples of 160, creating the stranded-remainder pattern flagged by the FTC. PO decision dated 2026-07-27: accept the locked, Genshin-anchored bundle amounts knowingly. Mitigate with the real-money-equivalent display above; do not realign bundles without a new PO decision. | FTC v. Cognosphere order patterns | **PO-DECISION** |
