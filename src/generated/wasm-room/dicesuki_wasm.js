/* @ts-self-types="./dicesuki_wasm.d.ts" */
...
export class WasmRoom {
    ...
    handleMessage(json) {
        ...
        const ret = wasm.wasmroom_handleMessage(this.__wbg_ptr, ptr0, len0);
     ...
     */
    isSimulating() {
        const ret = wasm.wasmroom_isSimulating(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    tick(dt_ms) {
        const ret = wasm.wasmroom_tick(this.__wbg_ptr, dt_ms);
        return takeObject(ret);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dicesuki_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
